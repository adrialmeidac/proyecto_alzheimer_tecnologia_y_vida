...
<body>
    ...
    <main class="admin-content flex-grow-1">
        ...
        <h1 class="admin-title text-center mb-4">Gestión de Profesionales</h1>

        <div class="text-end mb-3">
            <button class="btn btn-primary" onclick="location.href='profesionales-nuevo.php'">
                Añadir Profesional
            </button>
        </div>
        ...
        <div class="admin-table table-responsive">
            <table class="table table-hover align-middle">
                ...
                <tbody id="tablaProfesionales">
                    <tr><td colspan="11" class="text-center">Cargando profesionales...</td></tr>
                </tbody>
            </table>
        </div>
   ...
   async function cargarProfesionales() {
    ...
    try {
        const res = await fetch("/controllers/admin-profesionales.php?action=listar");
        const data = await res.json();

        if (!data.success) {
            tabla.innerHTML = `<tr><td colspan="11" class="text-danger text-center">${data.error}</td></tr>`;
            return;
        }
        ...
        tabla.innerHTML = `<tr><td colspan="11" class="text-danger text-center">Error al cargar profesionales</td></tr>`;
    }
}
    ...
    async function eliminar(id) {
        ...
        try {
            ...
            if (data.success) cargarProfesionales();
